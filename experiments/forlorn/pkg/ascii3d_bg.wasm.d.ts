...
export const engine_disable_surface_id_capture: (a: number) => void;
export const engine_enable_surface_id_capture: (a: number) => void;
...
export const engine_get_tomb_debug_rooms: (a: number) => number;
...
export const engine_set_edges_force_visible: (a: number, b: number) => void;
...
export const engine_set_tomb_debug_rooms: (a: number, b: number) => void;
export const engine_surface_id_at: (a: number, b: number, c: number) => number;
export const engine_tomb_tri_room: (a: number, b: number) => number;
