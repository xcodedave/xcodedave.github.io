/**
 * Entry point called (from `worker-bootstrap.js`) for every message the
 * main thread sends this worker. `data` is the raw `MessageEvent.data`,
 * expected to be `{ type: "transcribe", fileName: string, fileBytes:
 * ArrayBuffer }` — not JSON (the `ArrayBuffer` is transferred zero-copy),
 * so we pull fields out with `js_sys::Reflect` instead of serde.
 * @param {any} data
 */
export function handle_message(data) {
    wasm.handle_message(data);
}
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 854, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__hcd145886396ed627);
            return ret;
        },
...
function wasm_bindgen__convert__closures_____invoke__hcd145886396ed627(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__hcd145886396ed627(arg0, arg1, arg2);
    if (ret[1]) {
